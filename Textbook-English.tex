...
\begin{quote}
Le Foll, Elen. to appear/October 2024. \emph{Textbook English: A
Multi-Dimensional Approach}
{[}\href{https://benjamins.com/catalog/scl}{Studies in Corpus
Linguistics}{]}. Amsterdam: John Benjamins.
\end{quote}

The book is based on revised versions of selected (sub)chapters from my
PhD thesis:
...
EFL textbooks used in a different educational context (see also
\textbf{lefollWhyWeNeed2022?}; McManus).
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, titlerule=0mm, opacityback=0, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Using the MFTE}, left=2mm, coltitle=black, breakable, rightrule=.15mm, bottomtitle=1mm, toprule=.15mm, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame]
...
\includegraphics{AppendixG_files/figure-pdf/unnamed-chunk-4-1.pdf}
...
\includegraphics{AppendixG_files/figure-pdf/unnamed-chunk-10-1.pdf}
...
\includegraphics{AppendixG_files/figure-pdf/unnamed-chunk-19-1.pdf}
