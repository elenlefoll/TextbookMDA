...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Using the MFTE}, colback=white, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, breakable, arc=.35mm, left=2mm, rightrule=.15mm, toptitle=1mm, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6]
