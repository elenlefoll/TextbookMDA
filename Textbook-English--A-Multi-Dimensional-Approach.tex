...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Using the MFTE}, toptitle=1mm, colframe=quarto-callout-tip-color-frame, opacityback=0, arc=.35mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, leftrule=.75mm, bottomrule=.15mm, breakable, bottomtitle=1mm, coltitle=black, rightrule=.15mm, titlerule=0mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white]
