# Appendix E: Data Analysis for the Model of Intra-Textbook Variation {.unnumbered}
...
First, the TEC data as processed in Appendix D is imported. It consists of `{r} nrow(TxBdata)  |> format(big.mark=",")` texts/files, each with logged standardised normalised frequencies for `{r} ncol(TxBdata)-6` linguistic features.
